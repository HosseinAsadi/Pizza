...
class User(models.Model):
    ...
    private_key = models.CharField(max_length=32, default='')
    public_key = models.CharField(max_length=32, default='')
...
class Food(models.Model):
    ...
    double_options = models.ForeignKey(DoubleOptions, on_delete=models.SET_NULL, null=True, blank=True)
    name = models.CharField(max_length=50)
    ...
    def to_json(self, fav=None, with_group=False):
        double_op = None
        if self.double_options is not None:
            double_op = self.double_options.to_json()
        context = {
            'foodId': self.food_id,
            'name': self.name,
...
class Order(models.Model):
    ...
    def to_json(self, with_detail=True, with_customer=False):
        context = {
            ...
            'deliveryDatetime': self.delivery_datetime,
            'isPreOrder': self.is_pre_order,
        }
